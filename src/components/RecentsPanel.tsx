...
const activateButton =
  "flex-1 flex items-center gap-2 min-w-0 pl-3 pr-1 py-1.5 text-sm text-left rounded-md cursor-pointer select-none focus:outline-none focus-visible:ring-2 focus-visible:ring-inset focus-visible:ring-[color:var(--accent)]";
...
const menuShell =
  "fixed z-50 min-w-[10rem] rounded-md border border-[color:var(--border)] bg-[color:var(--panel)] py-1 shadow-lg text-sm text-[color:var(--text)]";
